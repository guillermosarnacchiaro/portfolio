  ...
  return (
    <article className="overflow-hidden rounded-card border border-border bg-surface shadow-card">
      <div className="grid items-stretch lg:grid-cols-[3fr_2fr]">
        ...
        <div className="flex min-h-96 items-center justify-center overflow-hidden border-t border-border bg-[#e7e0d5] p-4 min-[380px]:p-6 sm:p-8 lg:border-t-0 lg:border-l">
          <div className="w-full max-w-md overflow-hidden rounded-sm border border-black/10 bg-[#f8f5ef] shadow-[0_28px_70px_rgba(39,35,31,0.18)]">
